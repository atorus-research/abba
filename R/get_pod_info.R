...
#' @export
get_pod_args_string <- function(line) {
  parts <- strsplit(line, ",")[[1]]
...
#' @export
get_pod_program_name <- function(line) {
  args_string <- get_pod_args_string(line)
  pattern <- "-f ([^,]+\\.R)"
